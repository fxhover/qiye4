...
(function(){
	...
	$('#layer787D7A3254770606771D11E976BA15B9').layer_ready(function(){
		layer_img_lzld('layer787D7A3254770606771D11E976BA15B9');
                        ...
                        <div class="row small_font" id="outputText"><div class="translated_result"><span style="line-height:220%;"><?php echo $config['company'];?>成立于2002年1月，公司是以内装饰设计、施工为主体，融建筑幕墙、建筑机电安装、电子与智能化、消防设施等为一体的专业化装饰企业，拥有国家建筑装修装饰工程专业承包一级资质，建筑装饰工程设计专项甲级资质。
